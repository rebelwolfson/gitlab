...
export default (
  { gitlabUrl, gitlabApiPathPrefix, assets, milestones, successComment, failTitle, failComment, labels, assignee, rejectAnauthorized },
  {
    envCi: { service } = {},
    env: {
      CI_PROJECT_URL,
  ...
  return {
    ...
    rejectAnauthorized: rejectAnauthorized === undefined ? true : rejectAnauthorized,
